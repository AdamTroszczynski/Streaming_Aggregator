<template>
  <svg
    ...
    class="lg:h-[50px] lg:w-[50px]"
  >
    <rect width="40" height="39.7452" fill="url(#pattern0_4198_697)" />
    <defs>
      <pattern
        id="pattern0_4198_697"
        patternContentUnits="objectBoundingBox"
        width="1"
        height="1"
      >
        <use
          xlink:href="#image0_4198_697"
          transform="matrix(0.0208333 0 0 0.0209669 0 -0.00320511)"
        />
      </pattern>
      <image
        id="image0_4198_697"
