...
const event6end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 23, 0, 0)
...
const sendData = (id: number) => {
  ...
  if(day.getFullYear() !== tomorrow.getFullYear() || day.getMonth() !== tomorrow.getMonth() || day.getDate() !== tomorrow.getDate()) return [];
  else return data;
