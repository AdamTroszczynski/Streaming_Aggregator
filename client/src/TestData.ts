...
const event1 = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 7, 0, 0)
const event1end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 8, 0, 0)

const event2 = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 10, 30, 0)
const event2end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 15, 0, 0)
...
const event4end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 11, 0, 0)

const event5 = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 16, 0, 0)
const event5end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 16, 30, 0)
const event6 = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 16, 0, 0)
const event6end = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 17, 0, 0)
...
[new Event(2, 'PREZENTACJE PROJEKTÓW', 'conference', 'en', 'xxx', event2.getTime(), event2end.getTime()), new Event(3, 'WYSTAWA ORGANIZACJI', 'presentation', 'en', 'xxx', event3.getTime(), event3end.getTime()), new Event(4, 'ROZMOWY Z REKRUTERAMI', 'presentation', 'pl', 'xxx', event4.getTime(), event4end.getTime())],
[new Event(5, 'OGŁOSZENIE WYNIKOW', 'training', 'en', 'xxx', event5.getTime(),event5end.getTime()), new Event(6, 'UROCZYSTE PODSUMOWANIE KONFERENCJI', 'conference', 'en', 'xxx', event6.getTime(),event6end.getTime())],
[new Event(5, 'OGŁOSZENIE WYNIKOW', 'training', 'en', 'xxx', event5.getTime(),event5end.getTime()), new Event(5, 'OGŁOSZENIE WYNIKOW', 'training', 'en', 'xxx', event5.getTime(),event5end.getTime())],
