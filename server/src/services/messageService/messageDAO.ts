 ...
 */
export const getMessageByIdDAO = async (id: string): Promise<Message | null> => {
 ...
 */
export const updateMessageDAO = async (id: string, content: string): Promise<Message> => {
 ...
 */
export const deleteMessageDAO = async (id: string): Promise<Message> => {
